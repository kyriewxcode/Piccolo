...
namespace Pilot
{
    ...
    void PBlurPass::setupPipelines()
    {
        ...
        VkShaderModule vert_shader_module = PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, BLUR_VERT);
    ...
    void PBlurPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
        ...
        VkWriteDescriptorSet& post_process_descriptor_image_sampler_info = post_process_descriptor_writes_info[1];
        post_process_descriptor_image_sampler_info.sType                 = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
        post_process_descriptor_image_sampler_info.pNext                 = NULL;
        post_process_descriptor_image_sampler_info.dstSet                = _descriptor_infos[0].descriptor_set;
        post_process_descriptor_image_sampler_info.dstBinding            = 1;
        post_process_descriptor_image_sampler_info.dstArrayElement       = 0;
        post_process_descriptor_image_sampler_info.descriptorType        = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
        post_process_descriptor_image_sampler_info.descriptorCount       = 1;
        post_process_descriptor_image_sampler_info.pImageInfo = &post_process_global_layout_image_sampler_image_info;
    ...
    void PBlurPass::updateResolutionData()
    {
